...
import { getFocusedBrowserContext, getFocusedTextContext, identifyGitHubEntity, removeGitHubPrefix } from "./helpers/getFocusedContext";
        ...
        if (contextSelectedUrl) {
            ...
            if (contextBrowserUrl) {
                ...
                if (getClipboardContext) {
                    await showHUD("🍊 Creating Fresh Workspace for " + removeGitHubPrefix(contextSelectedUrl) + " from Clipboard")
